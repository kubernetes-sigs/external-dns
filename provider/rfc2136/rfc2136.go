...
func NewRfc2136Provider(host string, port int, zoneName string, insecure bool, keyName string, secret string, secretAlg string, axfr bool, domainFilter provider.DomainFilter, dryRun bool, actions rfc2136Actions) (provider.Provider, error) {
