...
func NewAzureProvider(configFile string, domainFilter provider.DomainFilter, zoneIDFilter provider.ZoneIDFilter, resourceGroup string, dryRun bool) (*AzureProvider, error) {
