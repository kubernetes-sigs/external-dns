...
func TestAWSZones(t *testing.T) {
	...
	for _, ti := range []struct {
		...
		provider, _ := newAWSProviderWithTagFilter(t, provider.NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), ti.zoneIDFilter, ti.zoneTypeFilter, ti.zoneTagFilter, defaultEvaluateTargetHealth, false, []*endpoint.Endpoint{})
...
func TestAWSRecords(t *testing.T) {
	provider, _ := newAWSProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), provider.NewZoneIDFilter([]string{}), provider.NewZoneTypeFilter(""), false, false, []*endpoint.Endpoint{
...
func TestAWSCreateRecords(t *testing.T) {
	...
	provider, _ := newAWSProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), provider.NewZoneIDFilter([]string{}), provider.NewZoneTypeFilter(""), defaultEvaluateTargetHealth, false, []*endpoint.Endpoint{})
...
func TestAWSDeleteRecords(t *testing.T) {
	...
	provider, _ := newAWSProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), provider.NewZoneIDFilter([]string{}), provider.NewZoneTypeFilter(""), false, false, originalEndpoints)
...
func TestAWSApplyChanges(t *testing.T) {
	tests := []struct {
		...
		{"cached", func(p *AWSProvider) context.Context {
			...
			require.NoError(t, err)
			return context.WithValue(context.Background(), provider.RecordsContextKey, records)
		}, 0},
	}
...
func TestAWSApplyChangesDryRun(t *testing.T) {
	...
	provider, _ := newAWSProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), provider.NewZoneIDFilter([]string{}), provider.NewZoneTypeFilter(""), defaultEvaluateTargetHealth, true, originalEndpoints)
...
func TestAWSsubmitChangesError(t *testing.T) {
	provider, clientStub := newAWSProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), provider.NewZoneIDFilter([]string{}), provider.NewZoneTypeFilter(""), defaultEvaluateTargetHealth, false, []*endpoint.Endpoint{})
...
func newAWSProvider(t *testing.T, domainFilter provider.DomainFilter, zoneIDFilter provider.ZoneIDFilter, zoneTypeFilter provider.ZoneTypeFilter, evaluateTargetHealth, dryRun bool, records []*endpoint.Endpoint) (*AWSProvider, *Route53APIStub) {
...
func newAWSProviderWithTagFilter(t *testing.T, domainFilter provider.DomainFilter, zoneIDFilter provider.ZoneIDFilter, zoneTypeFilter provider.ZoneTypeFilter, zoneTagFilter provider.ZoneTagFilter, evaluateTargetHealth, dryRun bool, records []*endpoint.Endpoint) (*AWSProvider, *Route53APIStub) {
