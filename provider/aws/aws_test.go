...
func TestAWSZones(t *testing.T) {
	...
	for _, ti := range []struct {
		...
		provider, _ := newAWSProviderWithTagFilter(t, NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), NewSubdomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), ti.zoneIDFilter, ti.zoneTypeFilter, ti.zoneTagFilter, defaultEvaluateTargetHealth, false, []*endpoint.Endpoint{})
...
func TestAWSRecords(t *testing.T) {
	provider, _ := newAWSProvider(t, NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), NewSubdomainFilter([]string{}), NewZoneIDFilter([]string{}), NewZoneTypeFilter(""), false, false, []*endpoint.Endpoint{
...
func TestAWSCreateRecords(t *testing.T) {
	...
	provider, _ := newAWSProvider(t, NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), NewSubdomainFilter([]string{}), NewZoneIDFilter([]string{}), NewZoneTypeFilter(""), defaultEvaluateTargetHealth, false, []*endpoint.Endpoint{})
...
func TestAWSDeleteRecords(t *testing.T) {
	...
	provider, _ := newAWSProvider(t, NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), NewSubdomainFilter([]string{}), NewZoneIDFilter([]string{}), NewZoneTypeFilter(""), false, false, originalEndpoints)
...
func TestAWSApplyChangesDryRun(t *testing.T) {
	...
	provider, _ := newAWSProvider(t, NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), NewSubdomainFilter([]string{}), NewZoneIDFilter([]string{}), NewZoneTypeFilter(""), defaultEvaluateTargetHealth, true, originalEndpoints)
...
func TestAWSsubmitChangesError(t *testing.T) {
	provider, clientStub := newAWSProvider(t, NewDomainFilter([]string{"ext-dns-test-2.teapot.zalan.do."}), NewSubdomainFilter([]string{}), NewZoneIDFilter([]string{}), NewZoneTypeFilter(""), defaultEvaluateTargetHealth, false, []*endpoint.Endpoint{})
...
func TestSubdomainFilter(t *testing.T) {
	provider, _ := newAWSProvider(t, NewDomainFilter([]string{}), NewSubdomainFilter([]string{"foo.example.org"}), NewZoneIDFilter([]string{}), NewZoneTypeFilter(""), defaultEvaluateTargetHealth, false, []*endpoint.Endpoint{})

	validChanges := []*route53.Change{
		{
			Action: aws.String(route53.ChangeActionCreate),
			ResourceRecordSet: &route53.ResourceRecordSet{
				Name: aws.String("bar.foo.example.org"),
			},
		},
		{
			Action: aws.String(route53.ChangeActionCreate),
			ResourceRecordSet: &route53.ResourceRecordSet{
				Name: aws.String("dev.bar.foo.example.org"),
			},
		},
		{
			Action: aws.String(route53.ChangeActionCreate),
			ResourceRecordSet: &route53.ResourceRecordSet{
				Name: aws.String("db-dev.foo.example.org"),
			},
		},
		{
			Action: aws.String(route53.ChangeActionCreate),
	...
	invalidChanges := []*route53.Change{
		{
			Action: aws.String(route53.ChangeActionCreate),
			ResourceRecordSet: &route53.ResourceRecordSet{
				Name: aws.String("foo.bar.example.org"),
			},
		},
		{
			Action: aws.String(route53.ChangeActionCreate),
			ResourceRecordSet: &route53.ResourceRecordSet{
				Name: aws.String("foobar.example.org"),
			},
		},
		{
			Action: aws.String(route53.ChangeActionCreate),
			ResourceRecordSet: &route53.ResourceRecordSet{
				Name: aws.String("bar.foo.bar.example.org"),
			},
		},
		{
			Action: aws.String(route53.ChangeActionCreate),
	...
	validFilteredChanges := filteredChangesBySubdomains(validChanges, provider)
	validateAWSChangeRecords(t, validChanges, validFilteredChanges)

	invalidFilteredChanges := filteredChangesBySubdomains(invalidChanges, provider)
	validateAWSChangeRecords(t, invalidFilteredChanges, []*route53.Change{})
}
...
func newAWSProvider(t *testing.T, domainFilter DomainFilter, subdomainFilter SubdomainFilter, zoneIDFilter ZoneIDFilter, zoneTypeFilter ZoneTypeFilter, evaluateTargetHealth, dryRun bool, records []*endpoint.Endpoint) (*AWSProvider, *Route53APIStub) {
	return newAWSProviderWithTagFilter(t, domainFilter, subdomainFilter, zoneIDFilter, zoneTypeFilter, NewZoneTagFilter([]string{}), evaluateTargetHealth, dryRun, records)
}

func newAWSProviderWithTagFilter(t *testing.T, domainFilter DomainFilter, subdomainFilter SubdomainFilter, zoneIDFilter ZoneIDFilter, zoneTypeFilter ZoneTypeFilter, zoneTagFilter ZoneTagFilter, evaluateTargetHealth, dryRun bool, records []*endpoint.Endpoint) (*AWSProvider, *Route53APIStub) {
