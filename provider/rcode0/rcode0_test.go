...
func TestRcodeZeroProvider_ApplyChanges(t *testing.T) {
	...
	provider := &RcodeZeroProvider{
		...
		DomainFilter: provider.NewDomainFilter([]string{testZoneOne}),
	}
...
func TestNewRcodeZeroProvider(t *testing.T) {
	...
	p, err := NewRcodeZeroProvider(provider.NewDomainFilter([]string{"ext-dns-test." + testZoneOne + "."}), true, true)
	...
	p, err = NewRcodeZeroProvider(provider.DomainFilter{}, false, false)
	...
	_, err = NewRcodeZeroProvider(provider.DomainFilter{}, false, false)
