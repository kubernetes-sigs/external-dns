...
func TestGoogleZonesIDFilter(t *testing.T) {
	provider := newGoogleProviderZoneOverlap(t, provider.NewDomainFilter([]string{"cluster.local."}), provider.NewZoneIDFilter([]string{"10002"}), false, []*endpoint.Endpoint{})
...
func TestGoogleZonesNameFilter(t *testing.T) {
	provider := newGoogleProviderZoneOverlap(t, provider.NewDomainFilter([]string{"cluster.local."}), provider.NewZoneIDFilter([]string{"internal-2"}), false, []*endpoint.Endpoint{})
...
func TestGoogleZones(t *testing.T) {
	provider := newGoogleProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.gcp.zalan.do."}), provider.NewZoneIDFilter([]string{""}), false, []*endpoint.Endpoint{})
...
func TestGoogleRecords(t *testing.T) {
	...
	provider := newGoogleProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.gcp.zalan.do."}), provider.NewZoneIDFilter([]string{""}), false, originalEndpoints)
...
func TestGoogleRecordsFilter(t *testing.T) {
	...
	provider := newGoogleProvider(
		t,
		provider.NewDomainFilter([]string{
			// our two valid zones
...
func TestGoogleUpdateRecords(t *testing.T) {
	...
	provider := newGoogleProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.gcp.zalan.do."}), provider.NewZoneIDFilter([]string{""}), false, currentRecords)
...
func TestGoogleApplyChangesDryRun(t *testing.T) {
	...
	provider := newGoogleProvider(t, provider.NewDomainFilter([]string{"ext-dns-test-2.gcp.zalan.do."}), provider.NewZoneIDFilter([]string{""}), true, originalEndpoints)
...
func newGoogleProviderZoneOverlap(t *testing.T, domainFilter provider.DomainFilter, zoneIDFilter provider.ZoneIDFilter, dryRun bool, records []*endpoint.Endpoint) *GoogleProvider {
...
func newGoogleProvider(t *testing.T, domainFilter provider.DomainFilter, zoneIDFilter provider.ZoneIDFilter, dryRun bool, records []*endpoint.Endpoint) *GoogleProvider {
	provider := &GoogleProvider{
		project:                  "zalando-external-dns-test",
		dryRun:                   false,
		domainFilter:             domainFilter,
