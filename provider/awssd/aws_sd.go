...
type AWSSDProvider struct {
	...
	namespaceFilter provider.DomainFilter
...
func NewAWSSDProvider(domainFilter provider.DomainFilter, namespaceType string, assumeRole string, dryRun bool) (*AWSSDProvider, error) {
