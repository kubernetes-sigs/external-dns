...
func (p *CloudFlareProvider) submitDataLocalizationRegionalHostnameChanges(ctx context.Context, changes []regionalHostnameChange, resourceContainer *cloudflare.ResourceContainer) bool {
	failedChange := false
