...
func testDnsimpleProviderApplyChanges(t *testing.T) {
	...
	changes.Create = []*endpoint.Endpoint{{DNSName: "example.example.com", Target: "target"}}
	changes.Delete = []*endpoint.Endpoint{{DNSName: "example-beta.example.com", Target: "127.0.0.1"}}
	changes.UpdateNew = []*endpoint.Endpoint{{DNSName: "example.example.com", Target: "target"}}
