...
func NewAlibabaCloudProvider(configFile string, domainFilter provider.DomainFilter, zoneIDFileter provider.ZoneIDFilter, zoneType string, dryRun bool) (*AlibabaCloudProvider, error) {
