...
var (
	...
	overriddenConfig = &Config{
		...
		InfobloxGridHostRO:          "127.0.0.1", // no tests so far for a setup with separate hosts for 'read' and 'write' operations
		InfobloxWapiPortRO:          8443,
		InfobloxWapiUsernameRO:      "infoblox",
		InfobloxWapiPasswordRO:      "infoblox",
		InfobloxWapiVersionRO:       "2.6.1",
