...
var (
	...
	overriddenConfig = &Config{
		...
		InfobloxWapiUsername:        "user1",
		InfobloxWapiPassword:        "pass1",
		InfobloxWapiVersion:         "2.6.1",
		InfobloxGridHostRO:          "127.0.0.2",
		InfobloxWapiPortRO:          8444,
		InfobloxWapiUsernameRO:      "user2",
		InfobloxWapiPasswordRO:      "pass2",
		InfobloxWapiVersionRO:       "2.6.2",
		InfobloxView:                "internal2",
		InfobloxSSLVerify:           false,
		InfobloxClientCert:          "/some/path/to/rw/cert",
		InfobloxClientKey:           "/some/path/to/rw/key",
		InfobloxSSLVerifyRO:         false,
		InfobloxClientCertRO:        "/some/path/to/ro/cert",
		InfobloxClientKeyRO:         "/some/path/to/ro/key",
		InfobloxMaxResults:          2001,
		InfobloxCacheDuration:       10,
	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--infoblox-wapi-username=user1",
				"--infoblox-wapi-password=pass1",
				"--no-infoblox-ssl-verify",
				"--infoblox-client-cert=/some/path/to/rw/cert",
				"--infoblox-client-key=/some/path/to/rw/key",
				"--infoblox-wapi-version=2.6.1",
				"--infoblox-grid-host-ro=127.0.0.2",
				"--infoblox-wapi-port-ro=8444",
				"--infoblox-wapi-username-ro=user2",
				"--infoblox-wapi-password-ro=pass2",
				"--infoblox-wapi-version-ro=2.6.2",
				"--no-infoblox-ssl-verify-ro",
				"--infoblox-client-cert-ro=/some/path/to/ro/cert",
				"--infoblox-client-key-ro=/some/path/to/ro/key",
				"--infoblox-view=internal2",
				"--infoblox-max-results=2001",
				"--infoblox-cache-duration=10",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_INFOBLOX_WAPI_USERNAME":          "user1",
				"EXTERNAL_DNS_INFOBLOX_WAPI_PASSWORD":          "pass1",
				"EXTERNAL_DNS_INFOBLOX_WAPI_VERSION":           "2.6.1",
				"EXTERNAL_DNS_INFOBLOX_SSL_VERIFY":             "false",
				"EXTERNAL_DNS_INFOBLOX_CLIENT_CERT":            "/some/path/to/rw/cert",
				"EXTERNAL_DNS_INFOBLOX_CLIENT_KEY":             "/some/path/to/rw/key",
				"EXTERNAL_DNS_INFOBLOX_GRID_HOST_RO":           "127.0.0.2",
				"EXTERNAL_DNS_INFOBLOX_WAPI_PORT_RO":           "8444",
				"EXTERNAL_DNS_INFOBLOX_WAPI_USERNAME_RO":       "user2",
				"EXTERNAL_DNS_INFOBLOX_WAPI_PASSWORD_RO":       "pass2",
				"EXTERNAL_DNS_INFOBLOX_WAPI_VERSION_RO":        "2.6.2",
				"EXTERNAL_DNS_INFOBLOX_SSL_VERIFY_RO":          "false",
				"EXTERNAL_DNS_INFOBLOX_CLIENT_CERT_RO":         "/some/path/to/ro/cert",
				"EXTERNAL_DNS_INFOBLOX_CLIENT_KEY_RO":          "/some/path/to/ro/key",
				"EXTERNAL_DNS_INFOBLOX_VIEW":                   "internal2",
				"EXTERNAL_DNS_INFOBLOX_MAX_RESULTS":            "2001",
				"EXTERNAL_DNS_INFOBLOX_CACHE_DURATION":         "10",
