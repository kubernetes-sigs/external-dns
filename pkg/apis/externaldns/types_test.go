...
var (
	...
	overriddenConfig = &Config{
		...
		InfobloxZoneFilter:          "(example\\.org|company\\.com)$",
		InfobloxRecordFilter:        ".*example.*",
	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--infoblox-zone-filter=(example\\.org|company\\.com)$",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_INFOBLOX_ZONE_FILTER":            "(example\\.org|company\\.com)$",
				"EXTERNAL_DNS_INFOBLOX_RECORD_FILTER":          ".*example.*",
