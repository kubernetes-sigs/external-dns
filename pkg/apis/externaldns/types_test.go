...
var (
	...
	overriddenConfig = &Config{
		...
		HetznerAPIPageSize:          100,
		HetznerAIgnoreNets:          "10.0.0.0/8",
	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--hetzner-api-page-size=100",
				"--hetzner-a-ignore-nets=10.0.0.0/8",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_HETZNER_API_PAGE_SIZE":           "100",
				"EXTERNAL_DNS_HETZNER_A_IGNORE_NETS":           "10.0.0.0/8",
