	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--node-selector=node-role.kubernetes.io/node=",
				"--max-node-port-targets=2",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_NODE_SELECTOR":                   "node-role.kubernetes.io/node=",
				"EXTERNAL_DNS_MAX_NODE_PORT_TARGETS":           "2",
				...
				"EXTERNAL_DNS_OMIT_SRV_RECORDS":                "1",
