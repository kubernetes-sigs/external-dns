...
func TestValidateFlags(t *testing.T) {
	...
	cfg = newValidConfig(t)
	cfg.AnnotationPrefixes = []string{}
	require.Error(t, ValidateConfig(cfg))

	cfg = newValidConfig(t)
	cfg.AnnotationPrefixes = []string{"custom.io"}
	require.Error(t, ValidateConfig(cfg))
	...
	require.Error(t, ValidateConfig(cfg))
	cfg = newValidConfig(t)
	cfg.AnnotationPrefixes = []string{"custom.io/", "external-dns.kubernetes.io"}
	require.Error(t, ValidateConfig(cfg))
	...
	cfg = newValidConfig(t)
	cfg.AnnotationPrefixes = []string{"external-dns.kubernetes.io/"}
	require.NoError(t, ValidateConfig(cfg))
...
func TestValidateBadAzureConfig(t *testing.T) {
	...
	cfg.Sources = []string{"test-source"}
	cfg.Provider = "azure"
	cfg.AnnotationPrefixes = []string{"external-dns.kubernetes.io/", "external-dns.alpha.kubernetes.io/"}
