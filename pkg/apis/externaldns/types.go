...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("managed-record-types", "Record types to manage (default: A, CNAME) (supported records: CNAME, A, NS). specify multiple times for multiple records").Default("A", "CNAME").StringsVar(&cfg.ManagedDNSRecordTypes)
