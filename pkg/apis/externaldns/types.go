...
type Config struct {
	...
	DomainFilter                      []string
	OnlyRegisteredDomainFilter        bool
...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("only-registered-domains-filter", "Filter zones by a registered in cluster domains only").BoolVar(&cfg.OnlyRegisteredDomainFilter)
