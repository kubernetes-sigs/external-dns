...
var defaultConfig = &Config{
	...
	TXTEncryptAESKey:            "",
	TXTFormats:                  []string{"old", "new", "metadata"},
...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("txt-formats", "When using the TXT registry, specify the TXT formats to use, supported formats are old,new and metadata (default: old, new, metadata) (supported records: old, new, metadata)").Default(defaultConfig.TXTFormats...).EnumsVar(&cfg.TXTFormats, "old", "new", "metadata")
