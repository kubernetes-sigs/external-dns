...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("aws-zone-id", "When using the AWS provider, filter target zones by hosted zone id; specify multiple times for multiple zones (optional)").Default("").StringsVar(&cfg.AWSZoneID)
