...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("managed-record-types", "Comma separated list of record types to manage (default: CNAME,A) (supported records: CNAME, A, NS").Default("CNAME,A").StringsVar(&cfg.ManagedDNSRecordTypes)
