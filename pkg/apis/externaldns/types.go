...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("aws-record-set-size-values", "When using the AWS provider, truncate resource record that can be included in a record set to this number.").Default(strconv.Itoa(defaultConfig.AWSRecordSetSizeValues)).IntVar(&cfg.AWSRecordSetSizeValues)
