...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("registry", "The registry implementation to use to keep track of DNS record ownership (default: txt, options: txt, noop, aws-sd, alibaba-cloud-sd)").Default(defaultConfig.Registry).EnumVar(&cfg.Registry, "txt", "noop", "aws-sd", "alibaba-cloud-sd")
