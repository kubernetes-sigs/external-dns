...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("provider", "The DNS provider where the DNS records will be created (required, options: akamai, aws, aws-sd, azure, azure-dns, azure-private-dns, bluecat, civo, cloudflare, coredns, designate, digitalocean, dnsimple, dyn, exoscale, gandi, godaddy, google, ibmcloud, infoblox, inmemory, linode, ns1, oci, ovh, pdns, rcodezero, rdns, rfc2136, safedns, scaleway, skydns, tencentcloud, transip, ultradns, vinyldns, vultr)").Required().PlaceHolder("provider").EnumVar(&cfg.Provider, "akamai", "aws", "aws-sd", "azure", "azure-dns", "azure-private-dns", "bluecat", "civo", "cloudflare", "coredns", "designate", "digitalocean", "dnsimple", "dyn", "exoscale", "gandi", "godaddy", "google", "ibmcloud", "infoblox", "inmemory", "linode", "ns1", "oci", "ovh", "pdns", "rcodezero", "rdns", "rfc2136", "safedns", "scaleway", "skydns", "tencentcloud", "transip", "ultradns", "vinyldns", "vultr")
