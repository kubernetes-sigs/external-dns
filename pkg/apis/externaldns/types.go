...
func App(cfg *Config) *kingpin.Application {
	...
	app.Flag("cloudflare-region-key", "When using the Cloudflare provider, specify the default region key for regional hostnames (optional)").StringVar(&cfg.CloudflareRegionKey)
