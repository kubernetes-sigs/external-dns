...
!!! warning
    With `--rfc2136-insecure-axfr`, zone transfer responses are unauthenticated.
    Only use this on a trusted network path, or combine it with `--rfc2136-use-tls`.

The `--rfc2136-insecure-axfr` flag skips TSIG on AXFR/zone-transfer requests while
...
| `--rfc2136-insecure` | `--rfc2136-gss-tsig` | `--rfc2136-insecure-axfr` | UPDATE auth | AXFR auth |
|----------------------|----------------------|---------------------------|-------------|-----------|
