...
from a different, unsigned endpoint than the TSIG-gated UPDATE endpoint — for
example a split-server PowerDNS setup where the AXFR server does not speak TSIG.
