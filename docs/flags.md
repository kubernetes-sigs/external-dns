...
| `--txt-apex-replacement=""` | When using the TXT registry, a custom string that's used for TXT records corresponding to apex domains defined by domain-filter (optional) |
