...
| skipped_records_label_too_long_total    | Counter     | registry         | record_type, domain                         | Total number of records skipped because the projected TXT registry name has a DNS label exceeding RFC 1035's 63-char limit (vector).               |
