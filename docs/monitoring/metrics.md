...
| deletions_skipped_by_policy             | Gauge       | controller       | owned                                       | Number of DNS record deletions skipped by the current policy, partitioned by owner (see docs/advanced/operational-best-practices.md).              |
