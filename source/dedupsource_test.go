...
func testDedupEndpoints(t *testing.T) {
	for _, tc := range []struct {
	...
	}{
		{
			...
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
			},
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
			},
		},
		{
			...
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
				{DNSName: "bar.example.org", Targets: endpoint.NewTargets("4.5.6.7")},
			},
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
				{DNSName: "bar.example.org", Targets: endpoint.NewTargets("4.5.6.7")},
		...
		},
		{
			...
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("4.5.6.7")},
			},
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("4.5.6.7")},
		...
		},
		{
			...
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
				{DNSName: "bar.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
			},
			[]*endpoint.Endpoint{
				{DNSName: "foo.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
				{DNSName: "bar.example.org", Targets: endpoint.NewTargets("1.2.3.4")},
