...
func (ms *nat64Source) Endpoints(ctx context.Context) ([]*endpoint.Endpoint, error) {

	parsedNAT64Prefixes := make([]netip.Prefix, 0)
	for _, prefix := range ms.nat64Prefixes {
...
func (ms *nat64Source) AddEventHandler(ctx context.Context, handler func()) {
