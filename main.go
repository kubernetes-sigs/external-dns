	...
	case "infoblox":
		p, err = infoblox.NewInfobloxProvider(
			infoblox.StartupConfig{
				...
				HostRO:        cfg.InfobloxGridHostRO,
				PortRO:        cfg.InfobloxWapiPortRO,
				UsernameRO:    cfg.InfobloxWapiUsernameRO,
				PasswordRO:    cfg.InfobloxWapiPasswordRO,
				VersionRO:     cfg.InfobloxWapiVersionRO,
				SSLVerifyRO:   cfg.InfobloxSSLVerifyRO,
				ClientCertRO:  cfg.InfobloxClientCertRO,
				ClientKeyRO:   cfg.InfobloxClientKeyRO,
