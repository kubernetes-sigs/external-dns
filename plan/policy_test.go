...
func TestApply(t *testing.T) {
	...
	// a simple entry with target change
	foo := []*Update{
		{
			Old: &endpoint.Endpoint{DNSName: "foo", Targets: endpoint.Targets{"v1"}},
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			&SyncPolicy{},
			&Changes{Create: baz, Update: foo, Delete: bar},
			&Changes{Create: baz, Update: foo, Delete: bar},
		},
		{
			...
			&UpsertOnlyPolicy{},
			&Changes{Create: baz, Update: foo, Delete: bar},
			&Changes{Create: baz, Update: foo, Delete: empty},
		},
		{
			// CreateOnlyPolicy clears the list of updates and deletions.
			&CreateOnlyPolicy{},
			&Changes{Create: baz, Update: foo, Delete: bar},
			&Changes{Create: baz, Update: []*Update{}, Delete: empty},
		},
	} {
		// apply policy
