...
func execute(ctx context.Context) {
	...
	if cfg.WebhookServer {
		webhookapi.StartHTTPApi(prvdr, nil, cfg.WebhookProviderReadTimeout, cfg.WebhookProviderWriteTimeout, cfg.WebhookProviderReadHeaderTimeout, cfg.WebhookProviderIdleTimeout, cfg.WebhookProviderMaxBodySize, "127.0.0.1:8888")
		os.Exit(0)
	}
