...
| [AWS Cloud Map](https://docs.aws.amazon.com/cloud-map/)                                                          | SIG           | [guide](docs/tutorials/aws-sd.md)                                                                                                                                                                                                                                                                          |
| [AWS Route 53](https://aws.amazon.com/route53/)                                                                  | SIG           | [Route 53](docs/tutorials/aws.md), [public & private zones](docs/tutorials/aws-public-private-route53.md), [filters](docs/tutorials/aws-filters.md), [LocalStack](docs/tutorials/aws-localstack.md), [Load Balancer Controller](docs/tutorials/aws-load-balancer-controller.md), [kube-ingress-aws](docs/tutorials/kube-ingress-aws.md) |
| [AzureDNS](https://azure.microsoft.com/en-us/services/dns)                                                       | SIG           | [Azure DNS](docs/tutorials/azure.md), [Private DNS](docs/tutorials/azure-private-dns.md)                                                                                                                                                                                                                    |
...
| [Google Cloud DNS](https://cloud.google.com/dns/docs/)                                                           | SIG           | [GKE default ingress](docs/tutorials/gke.md), [GKE with nginx](docs/tutorials/gke-nginx.md)                                                                                                                                                                                                                 |
| [Linode DNS](https://www.linode.com/docs/networking/dns/)                                                        |               | [guide](docs/tutorials/linode.md)                                                                                                                                                                                                                                                                          |
| [libdns adapter](https://github.com/libdns)                                                                      | SIG           | [transip](docs/tutorials/libdns.md)                                                                                                                                                                                                                                                                          |
