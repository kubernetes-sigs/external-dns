...
type ReferenceGrantLister interface {
	...
	List(selector labels.Selector) (ret []*apisv1.ReferenceGrant, err error)
...
type referenceGrantLister struct {
	listers.ResourceIndexer[*apisv1.ReferenceGrant]
}
...
func NewReferenceGrantLister(indexer cache.Indexer) ReferenceGrantLister {
	return &referenceGrantLister{listers.New[*apisv1.ReferenceGrant](indexer, apisv1.Resource("referencegrant"))}
}

// ReferenceGrants returns an object that can list and get ReferenceGrants.
func (s *referenceGrantLister) ReferenceGrants(namespace string) ReferenceGrantNamespaceLister {
	return referenceGrantNamespaceLister{listers.NewNamespaced[*apisv1.ReferenceGrant](s.ResourceIndexer, namespace)}
}
...
type ReferenceGrantNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisv1.ReferenceGrant, error)
