...
func (b *ListenerEntryApplyConfiguration) WithName(value apisv1.SectionName) *ListenerEntryApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *ListenerEntryApplyConfiguration) WithHostname(value apisv1.Hostname) *ListenerEntryApplyConfiguration {
	b.Hostname = &value
	return b
}
...
func (b *ListenerEntryApplyConfiguration) WithProtocol(value apisv1.ProtocolType) *ListenerEntryApplyConfiguration {
	b.Protocol = &value
	return b
}
...
func (b *ListenerEntryApplyConfiguration) WithTLS(value *ListenerTLSConfigApplyConfiguration) *ListenerEntryApplyConfiguration {
	b.TLS = value
	return b
}
