...
<<<<<<< HEAD:vendor/google.golang.org/grpc/internal/grpclog/prefixLogger.go
	ErrorDepth(1, fmt.Sprintf(format, args...))
}
...
||||||| parent of c5487e6d6 (NE-2142: UPSTREAM: 5739: Bump k8s and controller-runtime modules):vendor/google.golang.org/grpc/internal/grpclog/prefixLogger.go
	ErrorDepth(1, fmt.Sprintf(format, args...))
}
...
>>>>>>> c5487e6d6 (NE-2142: UPSTREAM: 5739: Bump k8s and controller-runtime modules):vendor/google.golang.org/grpc/internal/grpclog/prefix_logger.go
}
