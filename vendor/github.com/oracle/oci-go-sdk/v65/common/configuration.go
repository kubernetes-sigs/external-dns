...
func (p fileConfigurationProvider) Region() (value string, err error) {
	...
	if err != nil {
<<<<<<< HEAD:vendor/github.com/oracle/oci-go-sdk/common/configuration.go
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
...
=======
		return
||||||| parent of d03b4fbe9 (UPSTREAM: <carry>: update vendored files after rebase to v0.14.2):vendor/github.com/oracle/oci-go-sdk/common/configuration.go
		return
=======
		val, error := getRegionFromEnvVar()
		if error != nil {
		...
		value = val
>>>>>>> d03b4fbe9 (UPSTREAM: <carry>: update vendored files after rebase to v0.14.2):vendor/github.com/oracle/oci-go-sdk/v65/common/configuration.go
	}
