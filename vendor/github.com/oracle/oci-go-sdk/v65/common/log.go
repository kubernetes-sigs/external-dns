...
import (
	"fmt"
<<<<<<< HEAD:vendor/github.com/oracle/oci-go-sdk/common/log.go
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
	"io"
...
=======
||||||| parent of d03b4fbe9 (UPSTREAM: <carry>: update vendored files after rebase to v0.14.2):vendor/github.com/oracle/oci-go-sdk/common/log.go
=======
	"io"
>>>>>>> d03b4fbe9 (UPSTREAM: <carry>: update vendored files after rebase to v0.14.2):vendor/github.com/oracle/oci-go-sdk/v65/common/log.go
	"io/ioutil"
	"log"
	"os"
	"strings"
