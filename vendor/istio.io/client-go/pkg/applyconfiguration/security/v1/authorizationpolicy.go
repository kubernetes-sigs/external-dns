...
type AuthorizationPolicyApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *securityv1.AuthorizationPolicy `json:"spec,omitempty"`
...
func (b *AuthorizationPolicyApplyConfiguration) WithSpec(value securityv1.AuthorizationPolicy) *AuthorizationPolicyApplyConfiguration {
	b.Spec = &value
	return b
}
