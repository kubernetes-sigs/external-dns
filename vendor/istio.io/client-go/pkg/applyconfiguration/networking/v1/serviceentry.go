...
type ServiceEntryApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *networkingv1.ServiceEntry `json:"spec,omitempty"`
...
func (b *ServiceEntryApplyConfiguration) WithSpec(value networkingv1.ServiceEntry) *ServiceEntryApplyConfiguration {
	b.Spec = &value
	return b
}
