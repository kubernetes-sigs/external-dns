...
type DestinationRuleApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *networkingv1.DestinationRule `json:"spec,omitempty"`
...
func (b *DestinationRuleApplyConfiguration) WithSpec(value networkingv1.DestinationRule) *DestinationRuleApplyConfiguration {
	b.Spec = &value
	return b
}
