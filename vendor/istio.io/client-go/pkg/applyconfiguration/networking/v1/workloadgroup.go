...
type WorkloadGroupApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *networkingv1.WorkloadGroup `json:"spec,omitempty"`
...
func (b *WorkloadGroupApplyConfiguration) WithSpec(value networkingv1.WorkloadGroup) *WorkloadGroupApplyConfiguration {
	b.Spec = &value
	return b
}
