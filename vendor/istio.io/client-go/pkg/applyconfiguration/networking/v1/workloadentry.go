...
type WorkloadEntryApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *networkingv1.WorkloadEntry `json:"spec,omitempty"`
...
func (b *WorkloadEntryApplyConfiguration) WithSpec(value networkingv1.WorkloadEntry) *WorkloadEntryApplyConfiguration {
	b.Spec = &value
	return b
}
