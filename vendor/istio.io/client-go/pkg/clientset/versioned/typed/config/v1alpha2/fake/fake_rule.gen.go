...
func (c *FakeRules) UpdateStatus(ctx context.Context, rule *v1alpha2.Rule, opts v1.UpdateOptions) (*v1alpha2.Rule, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(rulesResource, "status", c.ns, rule), &v1alpha2.Rule{})
