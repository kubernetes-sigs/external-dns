...
type QuotaSpecInterface interface {
	...
	UpdateStatus(ctx context.Context, quotaSpec *v1alpha2.QuotaSpec, opts v1.UpdateOptions) (*v1alpha2.QuotaSpec, error)
...
func (c *quotaSpecs) UpdateStatus(ctx context.Context, quotaSpec *v1alpha2.QuotaSpec, opts v1.UpdateOptions) (result *v1alpha2.QuotaSpec, err error) {
	result = &v1alpha2.QuotaSpec{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("quotaspecs").
