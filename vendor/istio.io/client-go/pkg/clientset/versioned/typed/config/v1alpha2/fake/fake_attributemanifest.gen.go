...
func (c *FakeAttributeManifests) UpdateStatus(ctx context.Context, attributeManifest *v1alpha2.AttributeManifest, opts v1.UpdateOptions) (*v1alpha2.AttributeManifest, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(attributemanifestsResource, "status", c.ns, attributeManifest), &v1alpha2.AttributeManifest{})
