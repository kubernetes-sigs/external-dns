...
type RuleInterface interface {
	...
	UpdateStatus(ctx context.Context, rule *v1alpha2.Rule, opts v1.UpdateOptions) (*v1alpha2.Rule, error)
...
func (c *rules) UpdateStatus(ctx context.Context, rule *v1alpha2.Rule, opts v1.UpdateOptions) (result *v1alpha2.Rule, err error) {
	result = &v1alpha2.Rule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rules").
