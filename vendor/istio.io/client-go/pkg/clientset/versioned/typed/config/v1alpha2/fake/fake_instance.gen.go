...
func (c *FakeInstances) UpdateStatus(ctx context.Context, instance *v1alpha2.Instance, opts v1.UpdateOptions) (*v1alpha2.Instance, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(instancesResource, "status", c.ns, instance), &v1alpha2.Instance{})
